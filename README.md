...
Ready to use preset suitable for most applications. It makes following assumption about project structure:
...
- [examples](https://github.com/Noviel/webpack-features/tree/master/examples) directory
